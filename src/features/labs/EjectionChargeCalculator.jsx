  ...
  return (
    <section className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="mb-12 border-l-4 border-skillshot pl-8">
        <h2 className="mb-6 text-4xl font-black tracking-tighter text-black sm:text-6xl md:text-7xl uppercase break-words">
          {data.heading}
        </h2>
      ...
      <div className="grid gap-12 md:grid-cols-2">
        <div className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full border-2 border-black p-4 font-mono text-xl focus:outline-none focus:border-skillshot transition-colors"
          ...
          <div className="border-t-2 border-gray-100 pt-6 mt-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border-2 border-gray-200 p-2 font-mono text-lg focus:outline-none focus:border-skillshot transition-colors"
                />
              </div>
              <div>
                <label className="block text-xs font-bold uppercase tracking-widest text-gray-400 mb-1">
                ...
                <select
                  ...
                  className="w-full border-2 border-gray-200 p-2 font-mono text-sm focus:outline-none focus:border-skillshot transition-colors h-[46px]"
                >
            ...
            {calculatedShearPressure > 0 && (
              <div className="bg-gray-50 p-4 border border-gray-200 flex flex-col gap-2">
                ...
                <button
                  ...
                  className="w-full bg-black text-white py-2 px-4 text-xs font-bold uppercase tracking-widest hover:bg-skillshot hover:text-black transition-colors"
                >
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <input
                ...
                className="flex-1 h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-skillshot"
              />
              <span className="font-mono text-xl font-bold w-16 text-right">
                {pressure}
              </span>
            </div>
            <div className="flex gap-2 mt-2">
              <button
                ...
                className="text-xs font-bold uppercase tracking-widest text-gray-400 hover:text-black border border-gray-200 px-2 py-1 rounded hover:border-black transition-colors"
              >
        ...
        <div className="bg-gray-50 border-2 border-black p-8 flex flex-col justify-center">
          <div className="mb-8">
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            <p className="text-xs font-mono text-gray-500 whitespace-pre-line">
