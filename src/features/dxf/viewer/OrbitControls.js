...
export function OrbitControls(object, domElement) {
  ...
  function onMouseDown(event) {
    ...
    if (event.button === 0) {
      ...
      // Right Mouse
      // MODIFIED: Right click is ROTATE
  ...
  function onMouseWheel(event) {
    ...
    if (scope.object.top !== undefined) {
      ...
      var u = (mx - cx) / rect.width;
      var v = -(my - cy) / rect.height;

      var width = scope.object.right - scope.object.left;
      var height = scope.object.top - scope.object.bottom;

      var dx = width * u * (1 - scale);
      var dy = height * v * (1 - scale);
